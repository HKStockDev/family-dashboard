...
export function getDefaultData(): DashboardData {
  ...
  return {
    ...
    events: [
      // Monday
      { id: "e1", day: "mon", start: "06:00", end: "07:00", title: "Workout", memberId: "marcus", category: "fitness", icon: "dumbbell" },
      ...
      { id: "e5", day: "mon", start: "18:00", end: "22:00", title: "Work Shift", memberId: "marcus", category: "work", icon: "moon" },
      // Tuesday
      { id: "e6", day: "tue", start: "07:00", end: "08:30", title: "Pathophysiology", memberId: "olivia", category: "class", icon: "stethoscope" },
      { id: "e7", day: "tue", start: "09:00", end: "10:30", title: "Exercise Physiology", memberId: "noah", category: "class", icon: "dumbbell" },
      { id: "e8", day: "tue", start: "12:00", end: "13:00", title: "Lunch", category: "family" },
      { id: "e9", day: "tue", start: "13:00", end: "14:30", title: "Study Group", memberId: "olivia", category: "class", icon: "users" },
      { id: "e10", day: "tue", start: "19:00", end: "20:30", title: "Church", category: "church", icon: "church" },
      // Wednesday
      { id: "e11", day: "wed", start: "06:00", end: "07:00", title: "Workout", memberId: "marcus", category: "fitness", icon: "dumbbell" },
      { id: "e12", day: "wed", start: "08:00", end: "09:30", title: "Pharmacology", memberId: "olivia", category: "class", icon: "pill" },
      { id: "e13", day: "wed", start: "09:00", end: "10:30", title: "Microbiology Lab", memberId: "marcus", category: "class", icon: "microscope" },
      { id: "e14", day: "wed", start: "13:00", end: "14:30", title: "Library Study", memberId: "olivia", category: "class" },
      { id: "e15", day: "wed", start: "17:00", end: "18:00", title: "Pick Up Groceries", category: "chores", icon: "basket" },
      { id: "e16", day: "wed", start: "18:00", end: "22:00", title: "Work Shift", memberId: "marcus", category: "work", icon: "moon" },
      // Thursday
      { id: "e17", day: "thu", start: "08:00", end: "09:30", title: "Clinical Skills", memberId: "olivia", category: "class", icon: "stethoscope" },
      { id: "e18", day: "thu", start: "09:00", end: "10:30", title: "Nutrition", memberId: "noah", category: "class", icon: "apple" },
      ...
      { id: "e21", day: "thu", start: "17:00", end: "18:30", title: "Date Night", memberId: "marcus", category: "dateNight", icon: "heart" },
      // Friday
      { id: "e22", day: "fri", start: "06:00", end: "07:00", title: "Grocery Run", category: "chores", icon: "basket" },
      { id: "e23", day: "fri", start: "07:00", end: "08:30", title: "Pathophysiology Lab", memberId: "olivia", category: "class", icon: "stethoscope" },
      { id: "e24", day: "fri", start: "09:00", end: "10:30", title: "Statistics", memberId: "noah", category: "class" },
      { id: "e25", day: "fri", start: "13:00", end: "14:30", title: "Work on Project", category: "work", icon: "briefcase" },
      { id: "e26", day: "fri", start: "18:00", end: "22:00", title: "Work Shift", memberId: "marcus", category: "work", icon: "moon" },
      // Saturday
      { id: "e27", day: "sat", start: "07:00", end: "08:00", title: "Meal Prep", category: "chores", icon: "utensils" },
      { id: "e28", day: "sat", start: "10:00", end: "12:00", title: "Hike", category: "family", icon: "photo-hike" },
      { id: "e29", day: "sat", start: "19:00", end: "21:00", title: "Movie Night", category: "family", icon: "popcorn" },
      // Sunday
      { id: "e30", day: "sun", start: "09:00", end: "10:30", title: "Church", category: "church", icon: "church" },
